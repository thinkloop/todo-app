...
window.state = _todoReduxState.state;
...
(0, _todoReduxState.subscribe)(function () {
  return (0, _todoReactComponents.components)(appElement, _selectors2.default);
});
...
exports.default = function () {
	var selectedPage = _todoReduxState.state.selectedPage;
...
exports.default = function () {
	...
	return selectSiteHeader(selectedPage, _todoReduxState.actions.site.updateSelectedPage, PATHS, _todoReduxState.constants.PAGES.HOME, _todoReduxState.constants.PAGES.ABOUT);
};
...
exports.default = function () {
	...
	return selectTodos(todos, selectedSummaryStatus, _todoReduxState.actions.todos.addTodo, _todoReduxState.actions.todos.removeTodo, _todoReduxState.actions.todos.completeTodo, _todoReduxState.actions.todos.updateSelectedSummaryStatus, _todoReduxState.constants.TODOS_STATUSES);
};
